...
-- (removed) draw the ship
            -- love.graphics.setColor(256, 0, 0)
            -- love.graphics.circle('fill', shipX, shipY, shipRadius)

-- (removed) draw the cockpit
...
-- draw shippy!
    ...
    love.graphics.origin()
    -- experimental planet Earth with island
    -- love.graphics.setColor(0, 0, 256)
    -- love.graphics.circle('fill', -250, -250, 500)
    -- love.graphics.setColor(0, 1, 0)
    -- love.graphics.circle('fill', 50, 10, 30)
